...
//		llf.GetComponent<LevelLoadFade>().FadeAndLoadLevel(Color.black, 2.0f, true);
		...
		//healthUiSlider.fillAmount = hitPoints;
		...
		if(!showHealth){
			...
			//healthUiSlider.gameObject.SetActive(false);
		}
...
//	}
	...
	public void HealPlayer( float healAmt, bool isHungryThirsty = false ){
		...
		//healthUiSlider.fillAmount = Mathf.Round(hitPoints) / 100;
